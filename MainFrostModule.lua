...
function Library:Window(Title, Func, Options)
    ...
    Options.Gradient.Start = CheckType(Options.Gradient.Start, "Color3", Color3.fromRGB(0, 17, 255))
    Options.Gradient.End = CheckType(Options.Gradient.End, "Color3", Color3.fromRGB(0, 27, 22))
